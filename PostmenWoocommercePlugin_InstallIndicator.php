...
include_once( 'PostmenWoocommercePlugin_OptionsManager.php' );

class PostmenWoocommercePlugin_InstallIndicator extends PostmenWoocommercePlugin_OptionsManager {
